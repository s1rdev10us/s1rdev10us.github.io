!function (t, e) {
    ...
    function w(t, e) {
        var i = t.prototype;
        function n() { }
        for (var r in n.prototype = e.prototype,
            t.prototype = new n,
            i)
            t.prototype[r] = i[r];
        ...
        _drag: function (t) {
            ...
            if (e) {
                ...
                var o = this.findHover(i, n, e).target
                    , s = this._dropTarget;
                this._dropTarget = o,
                    e !== o && (s && o !== s && this.dispatchToElement(ut(s, t), "dragleave", t.event),
                        o && o !== s && this.dispatchToElement(ut(o, t), "dragenter", t.event))
            }
        },
        _dragEnd: function (t) {
            var e = this._draggingTarget;
            e && (e.dragging = !1),
                ...
                this._dropTarget && this.dispatchToElement(ut(this._dropTarget, t), "drop", t.event),
    ...
    function mt(t, e, i) {
        if (t[t.rectHover ? "rectContain" : "contain"](e, i)) {
            for (var n, r = t; r;) {
                if (r.clipPath && !r.clipPath.contain(e, i))
                    return !1;
                r.silent && (n = !0),
                    r = r.parent
            }
    ...
    vt.prototype = {
        ...
        dispatchToElement: function (t, e, i) {
            ...
            if (!n || !n.silent) {
                ...
                }(e, t, i); n && (n[r] && (a.cancelBubble = n[r].call(n, a)),
                    n.trigger(e, a),
                    n = n.parent,
                    !a.cancelBubble);)
                    ;
        ...
        findHover: function (t, e, i) {
            for (var n = this.storage.getDisplayList(), r = {
                ...
                var o;
                if (n[a] !== i && !n[a].ignore && (o = mt(n[a], t, e)) && (!r.topTarget && (r.topTarget = n[a]),
                    o !== ft)) {
                    r.target = n[a];
                    break
                }
        ...
        S(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function (t) {
            vt.prototype[t] = function (e) {
                ...
                if ("mousedown" === t)
                    ...
                    if (this._downEl !== this._upEl || !this._downPoint || rt(this._downPoint, [e.zrX, e.zrY]) > 4)
                        return;
    ...
    Pt.decomposeTransform = function () {
        if (this.transform) {
            var t = this.parent
                , e = this.transform;
            t && t.transform && (bt(Lt, t.invTransform, e),
                e = Lt);
        ...
        if (t) {
            ...
            if (r in Vt)
                return Yt(e, Vt[r]),
                    ...
                    e;
            if ("#" === r.charAt(0))
                return 4 === r.length ? (n = parseInt(r.substr(1), 16)) >= 0 && n <= 4095 ? (Ut(e, (3840 & n) >> 4 | (3840 & n) >> 8, 240 & n | (240 & n) >> 4, 15 & n | (15 & n) << 4, 1),
                    Kt(t, e),
                    e) : void Ut(e, 0, 0, 0, 1) : 7 === r.length ? (n = parseInt(r.substr(1), 16)) >= 0 && n <= 16777215 ? (Ut(e, (16711680 & n) >> 16, (65280 & n) >> 8, 255 & n, 1),
                        Kt(t, e),
                        e) : void Ut(e, 0, 0, 0, 1) : void 0;
            var a = r.indexOf("(")
                , o = r.indexOf(")");
            if (-1 !== a && o + 1 === r.length) {
                var s = r.substr(0, a)
                ...
                switch (s) {
                    case "rgba":
                        if (4 !== l.length)
                            return void Ut(e, 0, 0, 0, 1);
                        h = qt(l.pop());
                    case "rgb":
                        return 3 !== l.length ? void Ut(e, 0, 0, 0, 1) : (Ut(e, Gt(l[0]), Gt(l[1]), Gt(l[2]), h),
                            Kt(t, e),
                            e);
                    case "hsla":
                        return 4 !== l.length ? void Ut(e, 0, 0, 0, 1) : (l[3] = qt(l[3]),
                            Qt(l, e),
                            Kt(t, e),
                            e);
                    case "hsl":
                        return 3 !== l.length ? void Ut(e, 0, 0, 0, 1) : (Qt(l, e),
                            Kt(t, e),
                            e);
                    default:
                        return
    ...
    function Qt(t, e) {
        var i = (parseFloat(t[0]) % 360 + 360) % 360 / 360
            ...
            , a = r <= .5 ? r * (n + 1) : r + n - r * n
            , o = 2 * r - a;
        return Ut(e = e || [], Ht(255 * Xt(o, a, i + 1 / 3)), Ht(255 * Xt(o, a, i)), Ht(255 * Xt(o, a, i - 1 / 3)), 1),
            4 === t.length && (e[3] = t[3]),
            e
    }
    function Jt(t, e) {
    ...
    function de(t, e, i, n, r, a) {
        var o = t._getter
            ...
            , h = n.length;
        if (h) {
            var u, c = M(n[0].value), d = !1, f = !1, p = c ? function (t) {
        ...
        _animateToShallow: function (t, e, i, n, r) {
            ...
            for (var s in i)
                if (i.hasOwnProperty(s))
                    if (null != e[s])
                        L(i[s]) && !M(i[s]) ? this._animateToShallow(t ? t + "." + s : s, e[s], i[s], n, r) : (a[s] = i[s],
                            o++);
                    else if (null != i[s])
                        if (t) {
                            var l = {};
                            ...
                            this.attr(s, i[s]);
            return o > 0 && this.animate(t, !1).when(null == n ? 500 : n, a).delay(r || 0),
                this
        }
    };
    var xe = function (t) {
    ...
    xe.prototype = {
        ...
        b(xe, kt),
        b(xe, dt);
    var _e, we, be, Me, Se = ot, Te = Math.min, Ie = Math.max;
    function Ce(t, e, i, n) {
        i < 0 && (t += i,
            i = -i),
            n < 0 && (e += n,
    ...
    Ae.prototype = {
        ...
        _doAdd: function (t) {
            ...
            e && e !== t.__storage && (e.addToStorage(t),
                t instanceof Ae && t.addChildrenToStorage(e)),
                i && i.refresh()
        },
        remove: function (t) {
            var e = this.__zr
        ...
        addChildrenToStorage: function (t) {
            for (var e = 0; e < this._children.length; e++) {
                ...
                t.addToStorage(i),
                    i instanceof Ae && i.addChildrenToStorage(t)
            }
        },
        delChildrenFromStorage: function (t) {
            for (var e = 0; e < this._children.length; e++) {
                var i = this._children[e];
                t.delFromStorage(i),
                    i instanceof Ae && i.delChildrenFromStorage(t)
            }
        },
        dirty: function () {
    ...
    function Ne(t, e) {
        ...
        function s(s) {
            ...
            l += d,
                0 !== (h -= d) && 0 !== (c = Oe(t[l + h - 1], t, u, c, c - 1, e)) && (h <= c ? function (i, n, a, s) {
                    var l = 0;
                    for (l = 0; l < n; l++)
                        o[l] = t[i + l];
                    var h = 0
    ...
    ze.prototype = {
        ...
        addRoot: function (t) {
            t.__storage !== this && (t instanceof Ae && t.addChildrenToStorage(this),
                this.addToStorage(t),
                this._roots.push(t))
        },
        delRoot: function (t) {
    ...
    var Fe = {
        ...
        , He = [["shadowBlur", 0], ["shadowOffsetX", 0], ["shadowOffsetY", 0], ["shadowColor", "#000"], ["lineCap", "butt"], ["lineJoin", "miter"], ["miterLimit", 10]]
        , We = function (t, e) {
            this.extendFrom(t, !1),
                this.host = e
        };
    ...
    We.prototype = {
        ...
        bind: function (t, e, i) {
            ...
            if ((r || this.fill !== n.fill) && (t.fillStyle = this.fill),
                (r || this.stroke !== n.stroke) && (t.strokeStyle = this.stroke),
                (r || this.opacity !== n.opacity) && (t.globalAlpha = null == this.opacity ? 1 : this.opacity),
                (r || this.blend !== n.blend) && (t.globalCompositeOperation = this.blend || "source-over"),
                this.hasStroke()) {
        ...
        getGradient: function (t, e, i) {
            for (var n = ("radial" === e.type ? qe : Ge)(t, e, i), r = e.colorStops, a = 0; a < r.length; a++)
    ...
    $e.prototype = {
        ...
        clear: function (t, e) {
            ...
            (s && (this.domBack || this.createBackBuffer(),
                ...
                r.clearRect(0, 0, a, o),
                e && "transparent" !== e) && (e.colorStops ? (i = e.__canvasGradient || We.getGradient(r, e, {
                    x: 0,
                    y: 0,
                    width: a,
                    height: o
                }),
                    e.__canvasGradient = i) : e.image && (i = Ze.prototype.getCanvasPattern.call(e, r)),
                    r.save(),
                    r.fillStyle = i || e,
                    r.fillRect(0, 0, a, o),
                    r.restore());
    ...
    function ei(t, e, i, n, r) {
        if (t) {
            if ("string" == typeof t) {
                ...
                return a ? !ni(e = a.image) && a.pending.push(o) : (!e && (e = new Image),
                    e.onload = ii,
                    Je.put(t, e.__cachedImgObj = {
                        image: e,
                        pending: [o]
                    }),
    ...
    function gi(t, e, i, n) {
        ...
        for (var o = t = Math.max(0, t - 1), s = 0; s < r && o >= a; s++)
            o -= a;
        var l = ui(i);
        return l > o && (i = "",
            l = 0),
        ...
        for (var p = 0; p < o.length; p++) {
            for (var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
                ...
                if ("string" == typeof M && "%" === M.charAt(M.length - 1))
                    ...
                    null != A && A < M && (!S || A < C ? (D.text = "",
                        D.textWidth = M = 0) : (D.text = pi(D.text, A - C, w, c.ellipsis, {
                            minChar: c.minChar
                        }),
                            D.textWidth = ui(D.text, w),
                            M = D.textWidth + C))
    ...
    function Mi(t, e) {
        ...
        h < 0 && (s += h,
            ...
            u < 0 && (l += u,
                u = -u),
            "number" == typeof c ? i = n = r = a = c : c instanceof Array ? 1 === c.length ? i = n = r = a = c[0] : 2 === c.length ? (i = r = c[0],
        ...
        n.rich ? function (t, e, i, n, r) {
            ...
            !function (t, e, i, n, r) {
                ...
                for (var x = 0; x < i.lines.length; x++) {
                    for (var _, w = i.lines[x], b = w.tokens, M = b.length, S = w.lineHeight, T = w.width, I = 0, C = v, A = y, D = M - 1; I < M && (!(_ = b[I]).textAlign || "left" === _.textAlign);)
    ...
    function ki(t, e, i, n, r, a, o, s) {
        ...
        "top" === h ? u = a + i.height / 2 : "bottom" === h && (u = a + r - i.height / 2),
            !i.isLineHolder && Pi(l) && Li(t, e, l, "right" === s ? o - i.width : "center" === s ? o - i.width / 2 : o, u - i.height / 2, i.width, i.height);
        var c = i.textPadding;
        c && (o = Fi(o, s, c),
    ...
    function Li(t, e, i, n, r, a, o) {
        var s = i.textBackgroundColor
            ...
            , h = i.textBorderColor
            , u = P(s);
        if (Ni(e, "shadowBlur", i.textBoxShadowBlur || 0),
    ...
    function Ei(t, e, i) {
        ...
        if (i) {
            ...
            if (s instanceof Array)
                n = i.x + zi(s[0], i.width),
                    r = i.y + zi(s[1], i.height);
            else {
    ...
    Wi.prototype = {
        ...
        drawRectText: function (t, e) {
            ...
            if (null != n && (n += ""),
                ...
                i.transformText ? this.setTransform(t) : r && (Hi.copy(e),
                    Hi.applyTransform(r),
                    e = Hi),
                    Ai(this, t, n, i, e),
                    t.restore()
        ...
        Gi.prototype = {
            ...
            useStyle: function (t) {
                return this.style = new We(t, this),
                    this.dirty(!1),
                    this
            }
        },
        ...
        qi.prototype = {
            ...
            getBoundingRect: function () {
                var t = this.style;
                return this._rect || (this._rect = new Ce(t.x || 0, t.y || 0, t.width || 0, t.height || 0)),
                    this._rect
            }
        },
        w(qi, Gi);
    ...
    Zi.prototype = {
                ...
                for (var r = 0; r < e;) {
                    ...
                    o && o.__zr ? (r++,
                        o.invisible || (a.transform = o.transform,
                            ...
                            this._doPaintEl(a, i, !0, n))) : (t.splice(r, 1),
                                o.__hoverMir = null,
                                e--)
                }
                i.ctx.restore()
        ...
        _doPaintList: function (t, e) {
            ...
            for (var o = !0, s = 0; s < i.length; s++) {
                ...
                -1 === c && (console.error("For some unknown reason. drawIndex is -1"),
                    c = l.__startIndex);
                for (var v = c; v < l.__endIndex; v++) {
                    var m = t[v];
                    if (this._doPaintEl(m, l, e, u),
                        m.__dirty = !1,
                        d)
                        if (Date.now() - f > 15)
                            break
        ...
        _doPaintEl: function (t, e, i, n) {
            ...
            if ((e.__dirty || i) && !t.invisible && 0 !== t.style.opacity && (!a || a[0] || a[3]) && (!t.culling || !function (t, e, i) {
                return Ui.copy(t.getBoundingRect()),
        ...
        getLayer: function (t, e) {
            ...
            return i || ((i = new $e("zr_" + t, this, this.dpr)).zlevel = t,
                i.__builtin__ = !0,
        ...
        insertLayer: function (t, e) {
            var i = this._layers
                ...
                , s = this._domRoot;
            if (i[t])
                me("ZLevel " + t + " has been used already");
            else if (function (t) {
                ...
                me("Layer of zlevel " + t + " is not valid")
        },
        ...
        _updateLayerStatus: function (t) {
            ...
            for (i = 0; i < t.length; i++) {
                ...
                a.incremental ? ((o = this.getLayer(s + .001, this._needsManuallyCompositing)).incremental = !0,
                    r = 1) : o = this.getLayer(s + (r > 0 ? .01 : 0), this._needsManuallyCompositing),
                    o.__builtin__ || me("ZLevel " + s + " has been used by unkown layer " + o.id),
                    o !== n && (o.__used = !0,
    ...
    function $i(t, e, i, r) {
        return i = i || {},
            r || !n.canvasSupported ? Qi(t, e, i) : n.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (i.zrX = e.layerX,
                i.zrY = e.layerY) : null != e.offsetX ? (i.zrX = e.offsetX,
                    i.zrY = e.offsetY) : Qi(t, e, i),
            i
    }
    function Qi(t, e, i) {
        var n = function (t) {
    ...
    function Ji(t, e, i) {
        ...
        var a = e.button;
        return null == e.which && void 0 !== a && Ki.test(e.type) && (e.which = 1 & a ? 1 : 2 & a ? 3 : 4 & a ? 2 : 0),
            e
    }
    function tn(t, e, i) {
    ...
    var on = {
        pinch: function (t, e) {
            var i = t.length;
            if (i) {
                var n, r = (t[i - 1] || {}).points, a = (t[i - 2] || {}).points || r;
    ...
    function vn(t) {
        ...
        dt.call(this),
            ...
            n.pointerEventsSupported ? i(un, this) : (n.touchEventsSupported && i(ln, this),
                i(sn, this))
    }
    S(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function (t) {
        pn[t] = function (e) {
        ...
        return bn(e, function (t, n) {
            if (Mn(t)) {
                ...
                for (r = 0; r < i.length; r++) {
                    var a = i[r].exist;
                    if (!(i[r].option || null != a.id && null != t.id || null == t.name || Ln(t) || Ln(a) || a.name !== t.name + ""))
                        return i[r].option = t,
                            void (e[n] = null)
                }
            }
    ...
    var Zn = function (t) {
        ...
        , jn = Zn([["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]])
        , Kn = {
        ...
        , $n = Zn([["fill", "color"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["opacity"], ["shadowColor"]])
        , Qn = {
    ...
    function Dr(t, e, i, n, r, a, o, s, l, h) {
        var u, c = dr, d = ur, f = c(t, i, r, o, Cr);
        for (l[0] = 1 / 0,
            l[1] = 1 / 0,
            h[0] = -1 / 0,
            h[1] = -1 / 0,
        ...
        return !(u > e + c && u > n + c && u > a + c && u > s + c || u < e - c && u < n - c && u < a - c && u < s - c || h > t + c && h > i + c && h > r + c && h > o + c || h < t - c && h < i - c && h < r - c && h < o - c) && function (t, e, i, n, r, a, o, s, l, h, u) {
            ...
            for (var x = 0; x < 32 && !(v < ir); x++)
                d = c - v,
                    ...
                    p = at(or, ar),
                    d >= 0 && p < m ? (c = d,
                        m = p) : (sr[0] = ur(t, i, r, o, f),
                            sr[1] = ur(e, n, a, s, f),
                            g = at(sr, ar),
                            f <= 1 && g < m ? (c = f,
                                m = g) : v *= .5);
            return u && (u[0] = ur(t, i, r, o, c),
                u[1] = ur(e, n, a, s, c)),
                tr(m)
    ...
    qr.prototype = {
        ...
        setScale: function (t, e) {
            this._ux = Wr(1 / ge / t) || 0,
                this._uy = Wr(1 / ge / e) || 0
        },
        getContext: function () {
            return this._ctx
        },
        ...
        bezierCurveTo: function (t, e, i, n, r, a) {
            return this.addData(Lr.C, t, e, i, n, r, a),
        ...
        quadraticCurveTo: function (t, e, i, n) {
            return this.addData(Lr.Q, t, e, i, n),
        ...
        arc: function (t, e, i, n, r, a) {
            return this.addData(Lr.A, t, e, i, i, n, r - n, 0, a ? 0 : 1),
        ...
        _dashedLineTo: function (t, e) {
            var i, n, r = this._dashSum, a = this._dashOffset, o = this._lineDash, s = this._ctx, l = this._xi, h = this._yi, u = t - l, c = e - h, d = Hr(u * u + c * c), f = l, p = h, g = o.length;
            for (a < 0 && (a = r + a),
                f -= (a %= r) * (u /= d),
                p -= a * (c /= d); u > 0 && f <= t || u < 0 && f >= t || 0 == u && (c > 0 && p <= e || c < 0 && p >= e);)
                f += u * (i = o[n = this._dashIdx]),
                    p += c * i,
                    this._dashIdx = (n + 1) % g,
                    u > 0 && f < l || u < 0 && f > l || c > 0 && p < h || c < 0 && p > h || s[n % 2 ? "moveTo" : "lineTo"](u >= 0 ? Br(f, t) : zr(f, t), c >= 0 ? Br(p, e) : zr(p, e));
            u = f - t,
                c = p - e,
                this._dashOffset = -Hr(u * u + c * c)
        },
        _dashedBezierTo: function (t, e, i, n, r, a) {
            var o, s, l, h, u, c = this._dashSum, d = this._dashOffset, f = this._lineDash, p = this._ctx, g = this._xi, v = this._yi, m = ur, y = 0, x = this._dashIdx, _ = f.length, w = 0;
            for (d < 0 && (d = c + d),
                d %= c,
                o = 0; o < 1; o += .1)
                s = m(g, t, i, r, o + .1) - m(g, t, i, r, o),
                    l = m(v, e, n, a, o + .1) - m(v, e, n, a, o),
                    y += Hr(s * s + l * l);
            for (; x < _ && !((w += f[x]) > d); x++)
                ;
            for (o = (w - d) / y; o <= 1;)
        ...
        toStatic: function () {
            ...
            t instanceof Array && (t.length = this._len,
                Gr && (this.data = new Float32Array(t)))
        },
        getBoundingRect: function () {
            ...
            return 0 === a && (Or[0] = Or[1] = Er[0] = Er[1] = 0),
            ...
            for (var e, i, n, r, a, o, s = this.data, l = this._ux, h = this._uy, u = this._len, c = 0; c < u;) {
                ...
                d) {
                    ...
                    case Lr.L:
                        a = s[c++],
                            o = s[c++],
                            (Wr(a - n) > l || Wr(o - r) > h || c === u - 1) && (t.lineTo(a, o),
                                n = a,
                                r = o);
                        break;
                    case Lr.C:
    ...
    function ra(t, e, i, n, r, a, o, s, l, h) {
        ...
        for (var d, f, p = 0, g = -1, v = 0; v < c; v++) {
            var m = ia[v]
                , y = 0 === m || 1 === m ? .5 : 1;
            ur(t, i, r, o, m) < l || (g < 0 && (g = dr(e, n, a, s, na),
                na[1] < na[0] && g > 1 && (void 0,
                    u = na[0],
                    na[0] = na[1],
                    na[1] = u),
                d = ur(e, n, a, s, na[0]),
                g > 1 && (f = ur(e, n, a, s, na[1]))),
                2 == g ? m < na[0] ? p += d < e ? y : -y : m < na[1] ? p += f < d ? y : -y : p += s < f ? y : -y : m < na[0] ? p += d < e ? y : -y : p += s < d ? y : -y)
        }
        return p
    }
    function aa(t, e, i, n, r, a, o, s) {
        ...
        var l = function (t, e, i, n, r) {
            var a = t - 2 * e + i
                ...
                , l = 0;
            if (lr(a))
                hr(o) && (u = -s / o) >= 0 && u <= 1 && (r[l++] = u);
            else {
                var h = o * o - 4 * a * s;
                if (lr(h))
                    (u = -o / (2 * a)) >= 0 && u <= 1 && (r[l++] = u);
                else if (h > 0) {
                    var u, c = tr(h), d = (-o - c) / (2 * a);
    ...
    function oa(t, e, i, n, r, a, o, s) {
        ...
        for (var c = 0, d = 0; d < 2; d++) {
            ...
            if (f + t > o) {
                ...
                u = a ? 1 : -1;
                p < 0 && (p = ta + p),
                    (p >= n && p <= r || p + ta >= n && p + ta <= r) && (p > Math.PI / 2 && p < 1.5 * Math.PI && (u = -u),
                        c += u)
            }
        }
        return c
    ...
    function sa(t, e, i, n, r) {
        for (var a, o, s = 0, l = 0, h = 0, u = 0, c = 0, d = 0; d < t.length;) {
            var f = t[d++];
            switch (f === Jr.M && d > 1 && (i || (s += Qr(l, h, u, c, n, r))),
            1 == d && (u = l = t[d],
                c = h = t[d + 1]),
            f) {
                case Jr.M:
                ...
                case Jr.L:
                    if (i) {
                        if (Xr(l, h, t[d], t[d + 1], e, n, r))
                            return !0
                    } else
                        s += Qr(l, h, t[d], t[d + 1], n, r) || 0;
                    l = t[d++],
                        h = t[d++];
                    break;
                case Jr.C:
                    if (i) {
                        if (Ur(l, h, t[d++], t[d++], t[d++], t[d++], t[d], t[d + 1], e, n, r))
                            return !0
                    } else
                        s += ra(l, h, t[d++], t[d++], t[d++], t[d++], t[d], t[d + 1], n, r) || 0;
                    l = t[d++],
                        h = t[d++];
                    break;
                case Jr.Q:
                    if (i) {
                        if (Yr(l, h, t[d++], t[d++], t[d], t[d + 1], e, n, r))
                            return !0
                    } else
                        s += aa(l, h, t[d++], t[d++], t[d], t[d + 1], n, r) || 0;
                    l = t[d++],
                        h = t[d++];
                    break;
                case Jr.A:
                    var p = t[d++]
                        ...
                        , w = Math.cos(y) * v + p
                        , b = Math.sin(y) * m + g;
                    d > 1 ? s += Qr(l, h, w, b, n, r) : (u = w,
                        c = b);
                    var M = (n - p) * m / v + p;
                    if (i) {
                        if ($r(p, g, m, y, y + x, _, e, M, r))
                            return !0
                    } else
                        s += oa(p, g, m, y, y + x, _, M, r);
                    l = Math.cos(y + x) * v + p,
                        h = Math.sin(y + x) * m + g;
                    break;
                case Jr.R:
                    ...
                    w = u + t[d++],
                        b = c + t[d++];
                    if (i) {
                        if (Xr(u, c, w, c, e, n, r) || Xr(w, c, w, b, e, n, r) || Xr(w, b, u, b, e, n, r) || Xr(u, b, u, c, e, n, r))
                            return !0
                    } else
                        s += Qr(w, c, w, b, n, r),
                            s += Qr(u, b, u, c, n, r);
        ...
        return i || (a = h,
            o = c,
            Math.abs(a - o) < ea) || (s += Qr(l, h, u, c, n, r) || 0),
            0 !== s
    }
    ...
    ca.prototype = {
        ...
        brush: function (t, e) {
            var i, n = this.style, r = this.path || ua, a = n.hasStroke(), o = n.hasFill(), s = n.fill, l = n.stroke, h = o && !!s.colorStops, u = a && !!l.colorStops, c = o && !!s.image, d = a && !!l.image;
            (n.bind(t, this, e),
                this.setTransform(t),
                this.__dirty) && (h && (i = i || this.getBoundingRect(),
                    this._fillGradient = n.getGradient(t, s, i)),
                    u && (i = i || this.getBoundingRect(),
                        this._strokeGradient = n.getGradient(t, l, i)));
            h ? t.fillStyle = this._fillGradient : c && (t.fillStyle = la.call(s, t)),
                u ? t.strokeStyle = this._strokeGradient : d && (t.strokeStyle = la.call(l, t));
            var f = n.lineDash
                , p = n.lineDashOffset
                , g = !!t.setLineDash
                , v = this.getGlobalScale();
            r.setScale(v[0], v[1]),
                this.__dirtyPath || f && !g && a ? (r.beginPath(t),
                    f && !g && (r.setLineDash(f),
                        r.setLineDashOffset(p)),
        ...
        attrKV: function (t, e) {
            "shape" === t ? (this.setShape(e),
                this.__dirtyPath = !0,
                this._rect = null) : Gi.prototype.attrKV.call(this, t, e)
        },
    ...
    var da = qr.CMD
        ...
        , ga = Math.atan2
        , va = function (t, e) {
            var i, n, r, a, o, s = t.data, l = da.M, h = da.C, u = da.L, c = da.R, d = da.A, f = da.Q;
            for (r = 0,
                a = 0; r < s.length;) {
                switch (i = s[r++],
                a = r,
    ...
    function Ia(t, e) {
        var i = function (t) {
            ...
            var n, r = i.split("|"), a = 0, o = 0, s = new qr, l = qr.CMD;
            for (e = 1; e < r.length; e++) {
                ...
                for (; d < f.length && !isNaN(f[d]) && !isNaN(f[0]);) {
                    ...
                    switch (c) {
                        ...
                        case "c":
                            h = l.C,
                                s.addData(h, f[d++] + a, f[d++] + o, f[d++] + a, f[d++] + o, f[d++] + a, f[d++] + o),
                                a += f[d - 2],
                                o += f[d - 1];
                            break;
                        case "S":
                        ...
                        case "A":
                            m = f[d++],
                                ...
                                _ = f[d++],
                                w = f[d++],
                                Ta(b = a, M = o, a = f[d++], o = f[d++], _, w, m, y, x, h = l.A, s);
                            break;
                        case "a":
                            m = f[d++],
                                y = f[d++],
    ...
    Ca.prototype = {
        ...
        brush: function (t, e) {
            ...
            null != n && (n += ""),
                i.bind(t, this, e),
                Vi(n, i) && (this.setTransform(t),
                    Ai(this, t, n, i),
                    this.restoreTransform(t))
        },
        getBoundingRect: function () {
            var t = this.style;
            if (this.__dirty && Ii(t),
                !this._rect) {
                var e = t.text;
                null != e ? e += "" : e = "";
    ...
    var Aa = ca.extend({
        ...
        , Da = [["shadowBlur", 0], ["shadowColor", "#000"], ["shadowOffsetX", 0], ["shadowOffsetY", 0]]
        , ka = function (t) {
    ...
    var Ga = ca.extend({
        ...
        buildPath: function (t, e) {
            var i = e.x1
                ...
                , u = e.percent;
            0 !== u && (t.moveTo(i, n),
                null == l || null == h ? (u < 1 && (mr(i, o, r, u, Ha),
                    o = Ha[1],
                    r = Ha[2],
                    mr(n, s, a, u, Ha),
                    s = Ha[1],
                    a = Ha[2]),
                    t.quadraticCurveTo(o, s, r, a)) : (u < 1 && (fr(i, o, l, r, u, Ha),
                        o = Ha[1],
                        l = Ha[2],
                        r = Ha[3],
                        fr(n, s, h, a, u, Ha),
        ...
        , Xa = ca.extend({
            ...
            getBoundingRect: function () {
                return this._updatePathDirty(),
                    ca.prototype.getBoundingRect.call(this)
            }
        })
        , Ua = function (t) {
            this.colorStops = t || []
    ...
    function so(t) {
        var e = t.shape
            , i = t.style.lineWidth;
        return $a(2 * e.x1) === $a(2 * e.x2) && (e.x1 = e.x2 = lo(e.x1, i, !0)),
        ...
        if (!t.__isHover) {
            if (co(t),
                ...
                i && function (t) {
                    ...
                    i && (Ao(e, e.insideOriginalTextPosition, i),
    ...
    function Mo(t, e, i, n, r, a, o) {
        var s, l = (r = r || to).labelFetcher, h = r.labelDataIndex, u = r.labelDimIndex, c = i.getShallow("show"), d = n.getShallow("show");
        (c || d) && (l && (s = l.getFormattedLabel(h, "normal", null, u)),
            null == s && (s = k(r.defaultText) ? r.defaultText(h, r) : r.defaultText));
        var f = c ? s : null
            , p = d ? z(l ? l.getFormattedLabel(h, "emphasis", null, u) : null, s) : null;
        null == f && null == p || (So(t, i, a, r),
            So(e, n, o, r, !0)),
            t.text = f,
            e.text = p
    }
    ...
    function Io(t, e, i, n, r, a) {
        if (i = !r && i || to,
            ...
            t.textStroke = Co(e.getShallow("textBorderColor"), n) || i.textBorderColor,
            t.textStrokeWidth = z(e.getShallow("textBorderWidth"), i.textBorderWidth),
            !r) {
            if (a) {
        ...
        t.fontStyle = e.getShallow("fontStyle") || i.fontStyle,
            ...
            a && n.disableBox || (t.textBackgroundColor = Co(e.getShallow("backgroundColor"), n),
    ...
    function Oo(t, e, i) {
        return e && !M(e) && (e = kt.getLocalTransform(e)),
            i && (e = It([], e)),
            ot([], t, e)
    }
    function Eo(t, e, i, n) {
        ...
        function o(t) {
            ...
            return t.shape && (e.shape = v({}, t.shape)),
                e
        }
    }
    function No(t, e, i) {
        ...
        if (i = i || {
            ...
            return 0 === t.indexOf("image://") ? (n.image = t.slice(8),
                m(n, i),
                new qi(e)) : io(t.replace("path://", ""), e, i, "center")
    }
    var Ro = (Object.freeze || Object)({
        ...
        , Fo = Zn([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["textPosition"], ["textAlign"]])
        , Vo = {
    ...
    Go.prototype = {
        ...
        getShallow: function (t, e) {
            var i = this.option
                , n = null == i ? i : i[t]
                , r = !e && Xo(this, t);
            return null == n && r && (n = r.getShallow(t)),
                n
        },
        ...
        clone: function () {
            return new (0,
                this.constructor)(p(this.option))
        },
    ...
    function Ko(t, e) {
        ...
        return "string" == typeof t ? (i = t,
            i.replace(/^\s+/, "").replace(/\s+$/, "")).match(/%$/) ? parseFloat(t) / 100 * e : parseFloat(t) : null == t ? NaN : +t;
        var i
    }
    function $o(t, e, i) {
        return null == e && (e = 10),
    ...
    var gs = pi
        ...
        , ys = [["width", "left", "right"], ["height", "top", "bottom"]];
    ...
    function _s(t, e, i) {
        ...
        function o(i, r) {
            ...
            if (vs(i, function (e) {
                ...
                n[r])
                return l(e, i[1]) ? h[i[2]] = null : l(e, i[2]) && (h[i[1]] = null),
                    h;
            if (2 !== u && o) {
                if (o >= 2)
                    return a;
                ...
                if (t.length) {
                    ...
                    for (S(t, function (t) {
                        ...
                        var u = l.pop()
                            , c = s[u]
                            , d = !!h[u];
                        d && (r.call(a, u, c.originalDeps.slice()),
                            delete h[u]),
                            S(c.successor, d ? p : f)
                    }
                    S(h, function () {
        ...
        parallel: function (t, e, i, n) {
            ...
            S(a.parallelAxisIndex, function (t, a) {
                var s = r.getComponent("parallelAxis", t)
                    , l = o[a];
                i.set(l, s),
                    Ls(s) && null == e.firstCategoryDimIndex && (n.set(l, s),
        ...
        var u = function (t, e, i, n, r) {
            ...
            if (e === Es)
                "auto" === n || null == n ? Xs(function (t) {
                    ...
                    a = r ? r.length : i === Vs ? t.length : t[0] ? t[0].length : null;
            else if (e === Ns)
                r || (r = function (t) {
                    var e, i = 0;
    ...
    var Zs = "\0_ec_inner"
        , js = Go.extend({
                    ...
                    Ts.topologicalTravel(n, Ts.getAllClassMainTypes(), function (n, r) {
                            ...
                            bn(t, function (t, i) {
                                ...
                                bn(t, function (t, i) {
                                    var n = t.exist
                                        ...
                                        , a = t.keyInfo;
                                    if (Mn(r)) {
                                        if (a.name = null != r.name ? r.name + "" : n ? n.name : Tn + i,
                                            n)
                                            a.id = n.id;
                                        else if (null != r.id)
                                            a.id = r.id + "";
                        ...
                        e[n] = [],
                            ...
                            S(o, function (t, r) {
                                var a = t.exist
                                    , o = t.option;
                                if (W(L(o) || a, "Empty component definition"),
                                    o) {
            ...
            findComponents: function (t) {
                var e, i, n, r, a, o = t.query, s = t.mainType, l = (i = s + "Index",
                    n = s + "Id",
                    r = s + "Name",
                    !(e = o) || null == e[i] && null == e[n] && null == e[r] ? null : {
                        mainType: s,
                        index: e[i],
                        id: e[n],
                        name: e[r]
    ...
    sl.prototype = {
        ...
        setOption: function (t, e) {
            t && S(In(t.series), function (t) {
                ...
                t = nl(t, !0);
            var i, n, r = this._optionBackup, a = function (t, e, i) {
            ...
            this._newBaseOption = a.baseOption,
                r ? (i = r.baseOption,
                    ...
                    a.mediaDefault && (r.mediaDefault = a.mediaDefault)) : this._optionBackup = a
        },
        mountOption: function (t) {
            var e = this._optionBackup;
            return this._timelineOptions = rl(e.timelineOptions, nl),
        ...
        getMediaOption: function (t) {
            var e, i, n = this._api.getWidth(), r = this._api.getHeight(), a = this._mediaList, o = this._mediaDefault, s = [], l = [];
            if (!a.length && !o)
                return l;
            for (var h = 0, u = a.length; h < u; h++)
                ll(a[h].query, n, r) && s.push(h);
            return !s.length && o && (s = [-1]),
                s.length && (e = s,
                    i = this._currentMediaIndices,
                    e.join(",") !== i.join(",")) && (l = rl(s, function (t) {
    ...
    function vl(t) {
        t && (pl(t),
            gl(t, "label"),
            t.emphasis && gl(t.emphasis, "label"))
    }
    function ml(t) {
        return D(t) ? t : t ? [t] : []
    }
        ...
        hl(ml(t.series), function (t) {
            ul(t) && function (t) {
                if (ul(t)) {
                    ...
                    "gauge" === t.type ? (gl(t, "axisLabel"),
                        gl(t, "title"),
                        gl(t, "detail")) : "treemap" === t.type ? (fl(t.breadcrumb, "itemStyle"),
        ...
        e && i.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
            hl(i, function (e) {
                hl(ml(t[e]), function (t) {
                    t && (gl(t, "axisLabel"),
                        gl(t.axisPointer, "label"))
                })
            }),
            hl(ml(t.parallel), function (t) {
                var e = t && t.parallelAxisDefault;
                gl(e, "axisLabel"),
                    gl(e && e.axisPointer, "label")
            }),
    ...
    var wl = [["x", "left"], ["y", "top"], ["x2", "right"], ["y2", "bottom"]]
            ...
            var n = []
                ...
                , l = o.map(a, function (a, l, h) {
                    ...
                    for (var f = NaN, p = i - 1; p >= 0; p--) {
                        var g = t[p];
                        if (s || (c = g.data.rawIndexOf(g.stackedByDimension, u)),
                            c >= 0) {
    ...
    function Tl(t, e) {
        Hs.isInstance(t) || (t = Hs.seriesDataToSource(t)),
            this._source = t;
    ...
    function Nl(t, e) {
        ...
        return "time" === i && "number" != typeof t && null != t && "-" !== t && (t = +is(t)),
            null == t || "" === t ? NaN : +t
    }
    function Rl(t, e, i) {
        if (t) {
        ...
        , zl = {
            ...
            getFormattedLabel: function (t, e, i, n, r) {
                ...
                return "function" == typeof l ? (s.status = e,
                    l(s)) : "string" == typeof l ? function (t, e, i) {
                        D(e) || (e = [e]);
                        var n = e.length;
                        if (!n)
                            return "";
    ...
    Hl.perform = function (t) {
        ...
        var a, o = u(this._modBy), s = this._modDataCount || 0, l = u(t && t.modBy), h = t && t.modDataCount || 0;
        function u(t) {
            return !(t >= 1) && (t = 1),
                t
        }
        ...
        , mh = function (t, e) {
            ...
            if (i.get("show"))
                if (i.get("description"))
                    ...
                    var r, a = i.get("data.maxCount") || 10, o = i.get("series.maxCount") || 10, s = Math.min(n, o);
                    if (!(n < 1)) {
                        var l = function () {
                        ...
                        r += u(c(n > 1 ? "series.multiple.prefix" : "series.single.prefix"), {
                            ...
                            e.eachSeries(function (t, e) {
                                if (e < s) {
                                    var i, r = t.get("name"), o = "series." + (n > 1 ? "multiple" : "single") + ".";
                                    i = u(i = c(r ? o + "withName" : o + "withoutName"), {
                                        seriesId: t.seriesIndex,
                                        seriesName: t.get("name"),
                                        seriesType: (v = t.subType,
                                            vh.series.typeNames[v] || "自定义图")
                                    });
                                    var l = t.getData();
                                    window.data = l,
                                        l.count() > a ? i += u(c("data.partialData"), {
                                            displayCnt: a
                                        }) : i += c("data.allData");
                                    ...
                                    i += d.join(c("data.separator.middle")) + c("data.separator.end"),
                                        h.push(i)
                                }
                                var v
                            }),
                            r += h.join(c("series.multiple.separator.middle")) + c("series.multiple.separator.end"),
        ...
        _h.prepareStageTasks = function () {
            ...
            S(this._allHandlers, function (n) {
                ...
                n.reset && function (t, e, i, n, r) {
                    ...
                    n.overallReset && function (t, e, i, n, r) {
                        ...
                        var o = a.agentStubMap = a.agentStubMap || Z()
                            ...
                            , h = !0
                            , u = e.modifyOutputEnd;
                        s ? n.eachRawSeriesByType(s, c) : l ? l(n, r).each(c) : (h = !1,
                            S(n.getSeries(), c));
                        function c(e) {
                            var i = e.uid
                                , n = o.get(i);
    ...
    var Bh = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"]
        , zh = {
            color: Bh,
            colorLayer: [["#37A2DA", "#ffd85c", "#fd7b5f"], ["#37A2DA", "#67E0E3", "#FFDB5C", "#ff9f7f", "#E062AE", "#9d96f5"], ["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], Bh]
        }
    ...
    function Jh(t) {
        return function (e, i, n) {
            e = e && e.toLowerCase(),
                dt.prototype[t].call(this, e, i, n)
        }
    }
    function tu() {
        dt.call(this)
    ...
    function eu(t, e, i) {
        ...
        var r, a, o = this._api = (a = (r = this)._coordSysMgr,
            v(new Js(r), {
                ...
                getComponentByElement: function (t) {
                    for (; t;) {
                        ...
                        if (null != e)
                            return r._model.getComponent(e.mainType, e.index);
                        t = t.parent
                    }
                }
            }));
        ...
        Re(Mu, s),
            ...
            function (t, e) {
                t.on("rendered", function () {
                    e.trigger("rendered"),
                        !t.animation.isFinished() || e[$h] || e._scheduler.unfinished || e._pendingActions.length || e.trigger("finished")
                })
            }(n, this),
            X(this)
    }
    ...
    var ru = {
        ...
        updateView: function (t) {
            var e = this._model;
            e && (rh.markUpdateMethod(t, "updateView"),
                du(e),
                this._scheduler.performVisualTasks(e, t, {
                    setDirty: !0
                }),
    ...
    function ou(t, e, i, n, r) {
        ...
        if (n) {
            ...
            null != l && (l = Z(In(l))),
                a && a.eachComponent(s, function (e) {
                    l && null != l.get(e.id) || h(t["series" === n ? "_chartsMap" : "_componentsMap"][e.__viewId])
                }, t)
        } else
            Wh(t._componentsViews.concat(t._chartsViews), h);
        function h(n) {
    ...
    function lu(t, e) {
        ...
        t.batch && (h = !0,
            l = T(t.batch, function (e) {
                return (e = m(v({}, e), t)).batch = null,
                    e
            }));
        var u, c = [], d = "highlight" === i || "downplay" === i;
        Wh(l, function (t) {
            (u = (u = r.action(t, this._model, this._api)) || v({}, t)).type = a.event || u.type,
                c.push(u),
                d ? ou(this, s, t, "series") : o && ou(this, s, t, o.main, o.sub)
        }, this),
            "none" === s || d || o || (this[$h] ? (au(this),
                ru.update.call(this, t),
                this[$h] = !1) : ru[s].call(this, t)),
            u = h ? {
                type: a.event || i,
                escapeConnect: n,
                batch: c
    ...
    function cu(t, e, i, n) {
        for (var r = "component" === e, a = r ? t._componentsViews : t._chartsViews, o = r ? t._componentsMap : t._chartsMap, s = t._zr, l = t._api, h = 0; h < a.length; h++)
            a[h].__alive = !1;
        function u(t) {
            ...
            if (!h) {
                var u = Xh(t.type);
                (h = new (r ? Jl.getClass(u.main, u.sub) : rh.getClass(u.sub))).init(i, l),
                    o[e] = h,
                    a.push(h),
                    s.add(h.group)
            }
        ...
        for (h = 0; h < a.length;) {
            var c = a[h];
            c.__alive ? h++ : (!r && c.renderTask.dispose(),
                s.remove(c.group),
                c.dispose(i, l),
                a.splice(h, 1),
                delete o[c.__id],
    ...
    iu.resize = function (t) {
        ...
        iu.dispatchAction = function (t, e) {
            qh(e) || (e = {
                ...
                yu[t.type] && this._model && (this[Kh] ? this._pendingActions.push(t) : (lu.call(this, t, e.silent),
                    e.flush ? this._zr.flush(!0) : !1 !== e.flush && n.browser.weChat && this._throttledZrFlush(),
    ...
    Yu.prototype = {
        ...
        execute: function () {
            var t = this._old
                ...
                , n = []
                , r = [];
            for (Zu(t, {}, n, "_oldKeyGetter", this),
                Zu(e, i, r, "_newKeyGetter", this),
                a = 0; a < t.length; a++) {
                if (null != (s = i[o = n[a]]))
                    (h = s.length) ? (1 === h && (i[o] = null),
        ...
        this.dimensions = n,
            ...
            this._dimensionsSummary = function (t) {
                ...
                S(t.dimensions, function (e) {
                    var o, s = t.getDimensionInfo(e), l = s.coordDim;
                    if (l) {
                        var h = i[l];
                        i.hasOwnProperty(l) || (h = i[l] = []),
                            h[s.coordDimIndex] = e,
                            s.isExtraCoord || (n.set(l, 1),
    ...
    function uc(t, e) {
        var i = t._idList[e];
        return null == i && (i = sc(t, t._idDimIdx, e)),
            null == i && (i = $u + e),
            i
    }
    function cc(t) {
    ...
    function dc(t, e) {
        ...
        for (var r = n._storage = {}, a = t._storage, o = 0; o < i.length; o++) {
            var s = i[o];
            a[s] && (_(e, s) >= 0 ? (r[s] = fc(a[s]),
                n._rawExtent[s] = pc(),
                n._extent[s] = null) : r[s] = a[s])
        }
        return n
    }
    function fc(t) {
    ...
    oc.type = "list",
        ...
        oc.initData = function (t, e, i) {
            (Hs.isInstance(t) || M(t)) && (t = new Tl(t, this.dimensions.length)),
                ...
                this.defaultDimValueGetter = Ol[this._rawData.getSource().sourceFormat],
        ...
        oc._initDataFromProvider = function (t, e) {
            if (!(t >= e)) {
                for (var i, n = this._chunkSize, r = this._rawData, a = this._storage, o = this.dimensions, s = o.length, l = this._dimensionInfos, h = this._nameList, u = this._idList, c = this._rawExtent, d = this._nameRepeatCount = {}, f = this._chunkCount, p = f - 1, g = 0; g < s; g++) {
                    ...
                    var y = a[D][p];
                    if (y && y.length < n) {
                        for (var x = new m(Math.min(e - p * n, n)), _ = 0; _ < y.length; _++)
                            x[_] = y[_];
                        a[D][p] = x
                    }
                ...
                for (var b, M, T = new Array(s), I = t; I < e; I++) {
                    ...
                    var C = Math.floor(I / n)
                        , A = I % n;
                    for (w = 0; w < s; w++) {
                        var D, k = a[D = o[w]][C], P = this._dimValueGetter(T, D, I, w);
                        k[A] = P;
                        var L = c[D];
                        P < L[0] && (L[0] = P),
                            P > L[1] && (L[1] = P)
        ...
        oc.each = function (t, e, i, n) {
            if (this._count) {
                "function" == typeof t && (n = i,
                    ...
                    t = []),
                    i = i || n || this;
                for (var r = (t = T(cc(t), this.getDimension, this)).length, a = 0; a < this.count(); a++)
                    switch (r) {
                        case 0:
                            e.call(i, a);
                            break;
                        ...
                        if (1 === n) {
                            ...
                            for (f = 0; f < this._chunkCount; f++) {
                                ...
                                for (g = Math.min(this._count - f * this._chunkSize, this._chunkSize),
                                    ...
                                    var w = p[v]
                                        , b = _[v];
                                    (w >= l && w <= h || isNaN(w)) && (b >= y && b <= x || isNaN(b)) && (a[o++] = c),
                                        c++
                                }
                            }
                            u = !0
        ...
        oc.map = function (t, e, i, n) {
            ...
            r._indices = this._indices,
                r.getRawIndex = r._indices ? hc : lc;
    ...
    function vc(t, e, i) {
        ...
        var f = 0;
        function g(t, e, i) {
            null != ju.get(e) ? t.otherDims[e] = i : (t.coordDim = e,
                t.coordDimIndex = i,
                o.set(e, !0))
        }
        S(t, function (t, e) {
            ...
            if (!l.length)
                for (var h = 0; h < (n && n.length || 1); h++) {
                    for (; f < s.length && null != s[f].coordDim;)
                        f++;
                    f < s.length && l.push(f++)
                }
            S(l, function (e, r) {
        ...
        for (var w = y || "value", b = 0; b < l; b++) {
            null == (d = s[b] = s[b] || {}).coordDim && (d.coordDim = mc(w, o, _),
                d.coordDimIndex = 0,
    ...
    oc.setItemGraphicEl = function (t, e) {
        ...
        oc.cloneShallow = function (t) {
            ...
            if (t._storage = this._storage,
                ...
                t._indices = null;
            return t.getRawIndex = t._indices ? hc : lc,
                t
        }
        ,
    ...
    function wc(t, e, i) {
        i = i || {},
            Hs.isInstance(t) || (t = Hs.seriesDataToSource(t));
        var n, r = e.get("coordinateSystem"), a = el.get(r), o = ks(e);
        ...
        var u = function (t, e, i) {
            var n, r, a, o, s = (i = i || {}).byIndex, l = i.stackedCoordDimension, h = !(!t || !t.get("stack"));
            if (S(e, function (t, i) {
                P(t) && (e[i] = t = {
                    name: t
                }),
                    h && !t.isExtraCoord && (s || n || !t.ordinalMeta || (n = t),
    ...
    var Ac = eo({
        ...
        buildPath: function (t, e, i) {
            var n = e.symbolType
                , r = Cc[n];
            "none" !== e.symbolType && (r || (r = Cc[n = "rect"]),
    ...
    function kc(t, e, i, n, r, a, o) {
        ...
        return l && (t = t.substr(5, 1).toLowerCase() + t.substr(6)),
            (s = 0 === t.indexOf("image://") ? no(t.slice(8), new Ce(e, i, n, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? io(t.slice(7), {}, new Ce(e, i, n, r), o ? "center" : "cover") : new Ac({
                shape: {
                    symbolType: t,
                    x: e,
                    y: i,
    ...
    Lc._updateCommon = function (t, e, i, n) {
        ...
        var x = t.getItemVisual(e, "liftZ")
            , _ = r.__z2Origin;
        null != x ? null == _ && (r.__z2Origin = r.z2,
            r.z2 += x) : null != _ && (r.z2 = _,
                r.__z2Origin = null);
    ...
    function Xc(t, e, i) {
        var n, r = t.getBaseAxis(), a = t.getOtherAxis(r), o = function (t, e) {
            var i = 0
                , n = t.scale.getExtent();
            "start" === e ? i = n[0] : "end" === e ? i = n[1] : n[0] > 0 ? i = n[0] : n[1] < 0 && (i = n[1]);
            return i
        }(a, i), s = r.dim, l = a.dim, h = e.mapDimension(l), u = e.mapDimension(s), c = "x" === l || "radius" === l ? 1 : 0, d = T(t.dimensions, function (t) {
            return e.mapDimension(t)
        }), f = e.getCalculationInfo("stackResultDimension");
        return (n |= xc(e, d[0])) && (d[0] = f),
            (n |= xc(e, d[1])) && (d[1] = f),
        {
            dataDimsForPoint: d,
            valueStart: o,
        ...
        r || i.removeAll(),
            t.diff(r).add(function (n) {
                ...
                var h = r.getItemGraphicEl(l)
                    , u = t.getItemLayout(s);
                Wc(t, u, s, e) ? (h ? (h.updateData(t, s, o),
                    Po(h, {
                        position: u
    ...
    var nd = ca.extend({
        ...
        buildPath: function (t, e) {
            ...
            for (; n < r;)
                n += ed(t, i, n, r, r, 1, a.min, a.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1
        }
    })
        , rd = ca.extend({
            type: "ec-polygon",
            ...
            buildPath: function (t, e) {
                ...
                for (; r < a;) {
                    ...
                    ed(t, n, r + h - 1, h, a, -1, l.min, l.max, e.stackedOnSmooth, o, e.connectNulls),
                        r += h + 1,
                        t.closePath()
                }
            }
    ...
    function ld(t, e, i, n) {
        return "polar" === t.type ? function (t, e, i, n) {
            ...
            return e && (f.shape[o ? "width" : "height"] = 0,
                Lo(f, {
                    shape: {
                        width: h,
                        height: u
    ...
    rh.extend({
        ...
        render: function (t, e, i) {
            ...
            b && b.eachItemGraphicEl(function (t, e) {
                ...
                r.add(p);
            var M = !h && t.get("step");
            d && u.type === n.type && M === this._step ? (v && !f ? f = this._newPolygon(l, x, n, g) : f && !v && (p.remove(f),
                ...
                ad(this._stackedOnPoints, x) && ad(this._points, l) || (g ? this._updateAnimation(a, x, n, i, M, y) : (M && (l = hd(l, n, M),
                    x = hd(x, n, M)),
                    d.setShape({
                        points: l
                    }),
        ...
        highlight: function (t, e, i, n) {
            ...
            if (!(a instanceof Array) && null != a && a >= 0) {
                ...
                rh.prototype.highlight.call(this, t, e, i, n)
        },
        downplay: function (t, e, i, n) {
            var r = t.getData()
                , a = On(r, n);
            if (null != a && a >= 0) {
                ...
                rh.prototype.downplay.call(this, t, e, i, n)
        },
                        ...
                        dataEach: a.hasItemOption || h ? function (e, i) {
                            ...
                            if (e.hasItemOption) {
                                ...
                                null != o && e.setItemVisual(i, "symbol", o),
                                    ...
                                    null != h && e.setItemVisual(i, "symbolKeepAspect", h)
                            }
                        }
                            : null
                    }
                            ...
                            a && {
                                progress: function (t, e) {
                                    for (var o = t.end - t.start, s = n && new Float32Array(o * a), l = t.start, h = 0, u = [], c = []; l < t.end; l++) {
                                        ...
                                        n ? (s[h++] = d ? d[0] : NaN,
                                            s[h++] = d ? d[1] : NaN) : e.setItemLayout(l, d && d.slice() || [NaN, NaN])
                                    }
            ...
            getTicks: function () {
                return function (t, e, i, n) {
                    ...
                    if (!t)
                        return r;
                    e[0] < i[0] && r.push(e[0]);
                    for (var a = i[0]; a <= i[1] && (r.push(a),
                        (a = bd(a + t, n)) !== r[r.length - 1]);)
                        if (r.length > 1e4)
                            return [];
                    return e[1] > (r.length ? r[r.length - 1] : i[1]) && r.push(e[1]),
                        r
            ...
            niceTicks: function (t, e, i) {
                ...
                if (isFinite(r)) {
                    ...
                    var a = function (t, e, i, n) {
                        ...
                        return Td(r.niceTickExtent = [bd(Math.ceil(t[0] / o) * o, s), bd(Math.floor(t[1] / o) * o, s)], t),
                            r
                    }(n, t, e, i);
        ...
        , Zd = gd.extend({
            ...
            getTicks: function () {
                ...
                return T(Hd.getTicks.call(this), function (n) {
                    ...
                    return r = n === e[0] && t.__fixMin ? jd(r, i[0]) : r,
                        r = n === e[1] && t.__fixMax ? jd(r, i[1]) : r
                }, this)
            },
            getLabel: Hd.getLabel,
            scale: function (t) {
                return t = Vd.scale.call(this, t),
                    Ud(this.base, t)
            },
            setExtent: function (t, e) {
                var i = this.base;
            ...
            getExtent: function () {
                ...
                var i = this._originalScale
                    , n = i.getExtent();
                return i.__fixMin && (e[0] = jd(e[0], n[0])),
            ...
            niceTicks: function (t) {
                ...
                if (!(i === 1 / 0 || i <= 0)) {
                    var n, r = (n = i,
                        Math.pow(10, ns(n)));
                    for (t / i * r <= .5 && (r *= 10); !isNaN(r) && Math.abs(r) < 1 && Math.abs(r) > 0;)
                        r *= 10;
    ...
    function Kd(t, e) {
        ...
        "ordinal" === a ? i = e.getCategories().length : (D(n = e.get("boundaryGap")) || (n = [n || 0, n || 0]),
            ...
            t.setBlank(R(o) || R(s) || "ordinal" === a && !t.getOrdinalMeta().categories.length),
    ...
    function Jd(t) {
        var e, i = t.getLabelModel().get("formatter"), n = "category" === t.type ? t.scale.getExtent()[0] : null;
        return "string" == typeof i ? (e = i,
            i = function (t) {
    ...
    function sf(t, e) {
        return "category" === t.type ? function (t, e) {
            var i, n, r = hf(t, "ticks"), a = pf(e), o = uf(r, a);
            if (o)
                return o;
    ...
    function lf(t, e) {
        var i, n, r = hf(t, "labels"), a = pf(e), o = uf(r, a);
    ...
    var wf = ["value", "category", "time", "log"]
        ...
        , Mf = {
            getMin: function (t) {
                ...
                return this.axis && null != i && "dataMin" !== i && "function" != typeof i && !R(i) && (i = this.axis.scale.parse(i)),
                    i
            },
            getMax: function (t) {
                var e = this.option
                    , i = t || null == e.rangeEnd ? e.max : e.rangeEnd;
                return this.axis && null != i && "dataMax" !== i && "function" != typeof i && !R(i) && (i = this.axis.scale.parse(i)),
                    i
            },
        ...
        , Sf = Ts.extend({
            ...
            axis: null,
            init: function () {
                Sf.superApply(this, "init", arguments),
                    this.resetRange()
            },
            mergeOption: function () {
                Sf.superApply(this, "mergeOption", arguments),
                    this.resetRange()
            },
            restoreData: function () {
                Sf.superApply(this, "restoreData", arguments),
                    this.resetRange()
            },
    ...
    Df.type = "grid",
        ...
        Df.resize = function (t, e, i) {
            var n = function (t, e, i) {
                ...
                isNaN(u) && (u = r - l - c - o),
                null != f && (isNaN(h) && isNaN(u) && (f > n / r ? h = .8 * n : u = .8 * r),
                    isNaN(h) && (h = f * u),
                    isNaN(u) && (u = h / f)),
                isNaN(a) && (a = n - s - h - d),
                isNaN(o) && (o = r - l - u - c),
            ...
            a(),
                !i && t.get("containLabel") && (S(r, function (t) {
                    if (!t.model.get("axisLabel.inside")) {
                        var e = function (t) {
                            ...
                            if (e.get("axisLabel.show") && !i.isBlank()) {
                                ...
                                var s, l, h, u, c, d, f, p, g, v = t.getLabelModel(), m = Jd(t), y = 1;
                        ...
                        if (e) {
                            ...
                            n[i] -= e[i] + r,
                                "top" === t.position ? n.y += e.height + r : "left" === t.position && (n.x += e.width + r)
                        }
                    }
                }),
                    a())
        ...
        Df._findConvertTarget = function (t, e) {
            ...
            if (r)
                _(l, i = r.coordinateSystem) < 0 && (i = null);
            else if (a && o)
            ...
            function o(e) {
                return function (i, o) {
                    if (Cf(i, t)) {
                        ...
                        "x" === e ? "top" !== s && "bottom" !== s && n[s = "bottom"] && (s = "top" === s ? "bottom" : "top") : "left" !== s && "right" !== s && n[s = "left"] && (s = "left" === s ? "right" : "left"),
                            n[s] = !0;
    ...
    var zf = {
        ...
        axisName: function () {
            ...
            if (i) {
                var n, r, a = e.get("nameLocation"), o = t.nameDirection, s = e.getModel("nameTextStyle"), l = e.get("nameGap") || 0, h = this.axisModel.axis.getExtent(), u = h[0] > h[1] ? -1 : 1, c = ["start" === a ? h[0] - u * l : "end" === a ? h[1] + u * l : (h[0] + h[1]) / 2, Gf(a) ? t.labelOffset + o * l : 0], d = e.get("nameRotate");
                null != d && (d = d * Nf / 180),
                    Gf(a) ? n = Ff(t.rotation, null != d ? d : t.rotation, o) : (n = function (t, e, i, n) {
                        var r, a, o = Jo(i - t.rotation), s = n[0] > n[1], l = "start" === e && !s || "start" !== e && s;
                        ts(o - Nf / 2) ? (a = l ? "bottom" : "top",
                            r = "center") : ts(o - 1.5 * Nf) ? (a = l ? "top" : "bottom",
                                r = "center") : (a = "middle",
                                    r = o < 1.5 * Nf && o > Nf / 2 ? l ? "left" : "right" : l ? "right" : "left");
                        return {
                            rotation: o,
                            textAlign: r,
                            textVerticalAlign: a
                        ...
                        null != (r = t.axisNameAvailableWidth) && (r = Math.abs(r / Math.sin(n.rotation)),
                            !isFinite(r) && (r = null)));
                var f = s.getFont()
                ...
                So(b.style, s, {
                    ...
                    e.get("triggerEvent") && (b.eventData = Rf(e),
        ...
        , Ff = Bf.innerTextLayout = function (t, e, i) {
            var n, r, a = Jo(e - t);
            return ts(a) ? (r = i > 0 ? "top" : "bottom",
                n = "center") : ts(a - Nf) ? (r = i > 0 ? "bottom" : "top",
                    n = "center") : (r = "middle",
                        n = a > 0 && a < Nf ? i > 0 ? "right" : "left" : i > 0 ? "left" : "right"),
            {
                rotation: a,
                textAlign: n,
                textVerticalAlign: r
                    ...
                    if (d && ("auto" !== d || n || jf(c))) {
                        ...
                        var x = function (t, e) {
                            for (var i = e.model, n = e.dim, r = 0; r < t.length; r++) {
                                var a = t[r] || {};
                                if (Yf(a[n + "AxisId"], i.id) || Yf(a[n + "AxisIndex"], i.componentIndex) || Yf(a[n + "AxisName"], i.name))
                                    return r
                            }
                        }(a, h);
                        if (null != x) {
    ...
    function ep(t, e, i) {
        ...
        a.labelDirection = a.tickDirection = a.nameDirection = {
            ...
            B(i.labelInside, e.get("axisLabel.inside")) && (a.labelDirection = -a.labelDirection);
    ...
    rp.extend({
        ...
        qu({
            ...
            render: function (t, e) {
                this.group.removeAll(),
                    t.get("show") && this.group.add(new Fa({
        ...
        Fu(dd("line")),
        Bu(jh.PROCESSOR.STATISTIC, function (t) {
            return {
                seriesType: t,
                modifyOutputEnd: !0,
                reset: function (t, e, i) {
                    ...
                    if ("cartesian2d" === a.type && r) {
                        var o, s = a.getBaseAxis(), l = a.getOtherAxis(s), h = s.getExtent(), u = h[1] - h[0], c = Math.round(n.count() / u);
                        c > 1 && ("string" == typeof r ? o = fd[r] : "function" == typeof r && (o = r),
                            o && t.setData(n.downSample(n.mapDimension(l.dim), 1 / c, o, pd)))
                    }
                }
            }
        }("line")),
    ...
    sp.stopEffectAnimation = function () {
        ...
        Xu({
            ...
            _updateGroupTransform: function (t) {
                ...
                n && n.getRoamTransform && (this.group.transform = (e = n.getRoamTransform(),
                    wt(i = xt(), e),
                    i),
    ...
    mp.prototype = {
        ...
        getModel: function (t) {
            if (!(this.dataIndex < 0)) {
                var e, i = this.hostTree, n = i.data.getItemModel(this.dataIndex), r = this.getLevelModel();
                return r || 0 !== this.children.length && (0 === this.children.length || !1 !== this.isExpand) || (e = this.getLeavesModel()),
    ...
    function Mp(t, e, i) {
        ...
        this.add(n),
            ...
            this.on("emphasis", a).on("normal", o).on("mouseover", a).on("mouseout", o)
    }
    var Sp = Mp.prototype;
    Sp.updateData = function (t, e, i, n, r) {
        ...
        var h, u = function (t, e, i) {
            ...
            return a
        }(e, 0, r), c = o.getModel("itemStyle").getItemStyle();
        ...
        h = m({
            ...
            t ? (a.setShape(l),
                ...
                a.useStyle(h)) : "object" == typeof h.fill && h.fill.type || "object" == typeof a.style.fill && a.style.fill.type ? (Po(a, {
                    shape: l
                }, n),
                    a.useStyle(h)) : Po(a, {
                        shape: l,
        ...
        Sp.onEmphasis = function (t) {
            ...
            this.node.hostTree.root.eachNode(function (i) {
                var n, r, a;
                i.piece && (e.node === i ? i.piece.updateData(!1, i, "emphasis") : (n = i,
                    r = e.node,
                    (a = t) !== _p.NONE && (a === _p.SELF ? n === r : a === _p.ANCESTOR ? n === r || n.isAncestorOf(r) : n === r || n.isDescendantOf(r)) ? i.piece.childAt(0).trigger("highlight") : t !== _p.NONE && i.piece.childAt(0).trigger("downplay")))
            })
        }
        ,
        ...
        Sp._updateLabel = function (t, e, i) {
            ...
            var d, f = (l.startAngle + l.endAngle) / 2, p = Math.cos(f), g = Math.sin(f), v = M("position"), m = M("distance") || 0, y = M("align");
            "outside" === v ? (d = l.r + m,
                y = f > Math.PI / 2 ? "right" : "left") : y && "center" !== y ? "left" === y ? (d = l.r0 + m,
                    f > Math.PI / 2 && (y = "right")) : "right" === y && (d = l.r - m,
    ...
    rh.extend({
        ...
        render: function (t, e, i, n) {
            ...
            if (function (i, n) {
                        ...
                        if (i !== o && n !== o)
                            if (n && n.piece)
                                i ? (n.piece.updateData(!1, i, "normal", t, e),
                                    a.setItemGraphicEl(i.dataIndex, n.piece)) : function (t) {
                                        if (!t)
                                            return;
                                ...
                                var r = new Mp(i, t, e);
                                l.add(r),
                                    a.setItemGraphicEl(i.dataIndex, r)
                            }
                    }(u, c)
                }
                ...
                function (i, n) {
                    if (n.depth > 0) {
                        r.virtualPiece ? r.virtualPiece.updateData(!1, i, "normal", t, e) : (r.virtualPiece = new Mp(i, t, e),
                            l.add(r.virtualPiece)),
                            n.piece._onclickEvent && n.piece.off("click", n.piece._onclickEvent);
                        var a = function (t) {
                            r._rootToNode(n.parentNode)
                        };
                        n.piece._onclickEvent = a,
                            r.virtualPiece.on("click", a)
                    } else
                ...
                !f && o.children.length && (f = o.children[0].piece),
                    f && f.onNormal()
            }
            this._initEvents(),
                this._oldChildren = u
    ...
    function kp(t, e) {
        vf.call(this, "radius", t, e),
            this.type = "category"
    }
    function Pp(t, e) {
        e = e || [0, 360],
            vf.call(this, "angle", t, e),
            this.type = "category"
    }
    Vu(A(function (t) {
        return {
            ...
            e.eachSeriesByType(t, function (t) {
                ...
                null != v && function t(e, i) {
                    ...
                    e.children = function (t, e) {
                        ...
                        n.length && S(e.children, function (e) {
                            t(e, i)
                        })
                }(p, v);
                var m = 0;
    ...
    Lp.prototype = {
        ...
        pointToCoord: function (t) {
            ...
            e /= s,
                i /= s;
            for (var l = Math.atan2(-i, e) / Math.PI * 180, h = l < a ? 1 : -1; l < a || l > o;)
                l += 360 * h;
            return [s, l]
        },
            ...
            if (this.group.removeAll(),
                ...
                var i = t.axis
                    ...
                    , o = T(i.getViewLabels(), function (t) {
                        return (t = p(t)).coord = i.dataToCoord(t.tickValue),
                            t
                    });
                Wp(o),
                    Wp(a),
                ...
                var o = function (t, e) {
                    ...
                    return Xp(e.seriesModels, function (e, l) {
                        ...
                        if (e.getAxisTooltipData) {
                            ...
                            if (!(u = e.getData().indicesOfNearest(c[0], t, "category" === i.type ? .5 : null)).length)
                                return;
    ...
    var ag = qu({
        ...
        dispose: function (t, e) {
            rg("axisPointer", e),
                ag.superApply(this._model, "dispose", arguments)
        }
    })
        , og = En()
        , sg = p
    ...
    function ug(t, e, i, n) {
        ...
        )(og(i).lastProp, n) || (og(i).lastProp = n,
            e ? Po(i, n, t) : (i.stopAnimation(),
                i.attr(n)))
    }
    function cg(t, e) {
    ...
    function vg(t, e, i) {
        var n = xt();
        return St(n, n, i.rotation),
            Mt(n, n, i.position),
            Oo([t.dataToCoord(e), (i.labelOffset || 0) + (i.labelDirection || 1) * (i.labelMargin || 0)], n)
    }
    function mg(t, e, i) {
        return {
            x1: t[i = i || 0],
    ...
    var wg = {
        ...
        shadow: function (t, e, i, n) {
            var r, a, o, s = Math.max(1, t.getBandWidth()), l = i[1] - i[0];
            return {
                type: "Rect",
                shape: (r = [e - s / 2, i[0]],
                    a = [s, l],
            ...
            if (s) {
                Qp(r) && (r = function (t, e) {
                    ...
                    if (i.getTooltipPosition)
                        ...
                        n = l.dataToPoint(a.getValues(T(l.dimensions, function (t) {
                ...
                return Xp(u, function (t, e) {
                    ...
                    i && !f[e] && Xp(i.axesInfo, function (e, n) {
                        ...
                        if (e !== t && r) {
                            var a = r.value;
                            i.mapper && (a = t.axis.scale.parse(i.mapper(a, $p(e), $p(t)))),
                                v[t.key] = a
                        }
                    })
                }),
                    ...
                    function (t, e, i) {
                        ...
                        Xp(e, function (e, i) {
                            var r = e.axisPointerModel.option
                                , a = t[i];
                            a ? (!e.useHandle && (r.status = "show"),
                                r.value = a.value,
                                r.seriesDataIndices = (a.payloadBatch || []).slice()) : !e.useHandle && (r.status = "hide"),
    ...
    var Mg = hg.extend({
        makeElOption: function (t, e, i, n, r) {
            ...
            var o, s, l = a.polar, h = l.getOtherAxis(a).getExtent();
            o = a["dataTo" + (s = a.dim,
                s ? s.charAt(0).toUpperCase() + s.substr(1) : s)](e);
            var u = n.get("type");
            if (u && "none" !== u) {
                var c = pg(n)
                    , d = Sg[u](a, l, o, h, c);
            ...
            var f = function (t, e, i, n, r) {
                ...
                if ("radius" === a.dim) {
                    ...
                    var v = n.cx
                        , m = n.cy;
                    h = Math.abs(l[0] - v) / g < .3 ? "center" : l[0] > v ? "left" : "right",
                        u = Math.abs(l[1] - m) / g < .3 ? "middle" : l[1] > m ? "top" : "bottom"
                }
                return {
                    position: l,
                    align: h,
    ...
    $f.registerAxisPointerClass("PolarAxisPointer", Mg),
            ...
            var n = i.getWidth()
                ...
                , o = function (t, e) {
                    ...
                    S(t, function (t, e) {
                        ...
                        c && !h[u].width && (c = Math.min(l.remainedWidth, c),
                            h[u].width = c,
                            l.remainedWidth -= c),
                            d && (h[u].maxWidth = d),
                            null != f && (l.gap = f),
        ...
        t.setCanvasCreator = function (t) {
            var e, i;
            i = t,
                "createCanvas" == (e = "createCanvas") && (y = null),
                f[e] = i
        }
        ,
...
class CircularAudioWave {
    constructor(t, e = {}) {
        ...
        if (this.defaultChartOption = {
            ...
            window.AudioContext ? (this.context = new AudioContext,
                ...
                this.analyser = this.context.createAnalyser()) : alert("Your browser does not support Web Audio API"),
                ...
                e.onload = (() => {
                    this.offlineContext.decodeAudioData(e.response, t => {
                        ...
                        this.offlineContext.oncomplete = (e => {
                            ...
                            this.bpm = this._getBPM([i.getChannelData(0), i.getChannelData(1)]),
                                this._init(),
                                t()
                        }
                        )
    ...
    presetOption() {
        "sunburst" !== this.opts.mode && (this.chartOption.series[0].animation = !1,
            this.chartOption.series[2].rippleEffect.period = 150 / this.bpm)
    }
    play() {
        this.sourceNode && this.sourceNode.buffer ? (this.playing = !0,
            this.presetOption(),
            this.sourceNode.start(0),
            this._debouncedDraw()) : alert("Audio is not ready")
    }
    pause() { }
    destroy() {
        this.chart.dispose()
    ...
    _draw(t) {
        if (this.playing) {
            ...
            this.chartOption.series[0].data = e.data,
                e.maxR > this.lastMaxR ? this.lastMaxR = e.maxR + 4 : this.playing ? this.lastMaxR -= 2 : this.lastMaxR = this.minChartValue,
                "sunburst" !== this.opts.mode && (this.chartOption.series[1].data = Array.apply(null, {
                    length: 361
    ...
    _getBPM(t) {
        ...
        i.sort((t, e) => e.volume - t.volume),
            (i = i.splice(0, .5 * i.length)).sort((t, e) => t.position - e.position);
        let n = [];
        i.forEach((t, e) => {
